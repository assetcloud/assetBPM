...
package com.yonyougov.rest.service.api;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.yonyougov.rest.service.api.runtime.ProcTaskResponse;
...
import org.flowable.rest.service.api.repository.*;
...
/**
 * Default implementation of a {@link ProcRestResponseFactory}.
 * 
...
@Component
public class ProcRestResponseFactory {
    ...
    public ProcRestResponseFactory(ObjectMapper objectMapper) {
        this.objectMapper = objectMapper;
        initializeVariableConverters();
    }

    public List<ProcTaskResponse> createTaskResponseList(List<Task> tasks) {
        RestUrlBuilder urlBuilder = createUrlBuilder();
        List<ProcTaskResponse> responseList = new ArrayList<>();
    ...
    public ProcTaskResponse createTaskResponse(Task task) {
        return createTaskResponse(task, createUrlBuilder());
    }

    public ProcTaskResponse createTaskResponse(Task task, RestUrlBuilder urlBuilder) {
        ProcTaskResponse response = new ProcTaskResponse(task);
