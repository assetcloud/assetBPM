...
import com.yonyougov.rest.service.api.ProcRestResponseFactory;
...
public class ProcTaskBaseResource {
    ...
    @Autowired
    protected ProcRestResponseFactory procRestResponseFactory;
    ...
    @Autowired
    ProcRuIdentityService procRuIdentityService;
    ...
    /**
     * Populate the task based on the values that are present in the given {@link ProcTaskRequest}.
     */
    protected void populateTaskFromRequest(Task task, ProcTaskRequest taskRequest) {
    ...
    protected DataResponse<ProcTaskResponse> getTasksFromQueryRequest(ProcTaskQueryRequest request, Map<String, String> requestParams) {
        ...
        return paginateList(requestParams, request, taskQuery, "id", properties, procRestResponseFactory::createTaskResponseList);
    }
    ...
    protected void addTaskvariables(TaskQuery taskQuery, List<QueryVariable> variables) {
        ...
        for (QueryVariable variable : variables) {
            ...
            Object actualValue = procRestResponseFactory.getVariableValue(variable);
