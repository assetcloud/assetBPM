package com.yonyougov.rest.converter;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.node.ObjectNode;
import com.yonyougov.rest.utils.ExtensionAttributeUtils;
...
public class HmUserTaskJsonConverter extends UserTaskJsonConverter {
    ...
    protected FlowElement convertJsonToElement(JsonNode elementNode, JsonNode modelNode,Map<String, JsonNode> shapeMap) {
        ...
        //自定义扩展抢占模式
        if(elementNode.findValue("preemptmode")!=null) {
            boolean preemptmode = elementNode.findValue("preemptmode").asBoolean();
            ExtensionAttribute ea1 = new ExtensionAttribute();
            if(preemptmode) {
                //抢占模式
                ea1 = ExtensionAttributeUtils.generate("preemptmode","1");
            }else {
                ea1 = ExtensionAttributeUtils.generate("preemptmode","0");
            }
            attributesList.add(ea1);
        }
